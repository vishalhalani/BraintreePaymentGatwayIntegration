package com.vishal.braintreepaymentgatwayintegration;
...
public class MainActivity extends AppCompatActivity  {
    ...
    final String get_token = "http://192.168.1.111/braintreepayment/main.php";
    final String send_payment_details = "http://192.168.1.111/braintreepayment/checkout.php";
    ...
    private void clienttoken() {
        // make web call to get client token from our server
